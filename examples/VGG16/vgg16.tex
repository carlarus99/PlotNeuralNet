...
\pic[shift={(0,0,0)}] at (0,0,0) {RightBandedBox={name=cr1,caption=conv1,%
        xlabel={{"64","64"}},ylabel=32,zlabel=32,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(2,0,0)}] at (p1-east) {RightBandedBox={name=cr2,caption=conv2,%
        xlabel={{"128","128"}},zlabel=16,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(2,0,0)}] at (p2-east) {RightBandedBox={name=cr3,caption=conv3,%
        xlabel={{"256","256","256"}},zlabel=8,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(1.8,0,0)}] at (p3-east) {RightBandedBox={name=cr4,caption=conv4,%
        xlabel={{"512","512","512"}},zlabel=4,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(1.5,0,0)}] at (p4-east) {RightBandedBox={name=cr5,caption=conv5,%
        xlabel={{"512","512","512"}},zlabel=2,fill=\ConvColor,bandfill=\ConvReluColor,%
